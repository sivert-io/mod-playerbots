...
public:
    TriggerContext()
    {
        ...
        creators["social afk status"] = &TriggerContext::social_afk_status;
...
private:
    ...
    static Trigger* social_afk_status(PlayerbotAI* botAI) { return new NewRpgStatusTrigger(botAI, RPG_SOCIAL_AFK); }
